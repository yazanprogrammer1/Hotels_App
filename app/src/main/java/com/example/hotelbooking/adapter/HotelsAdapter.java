...
import com.example.hotelbooking.Activitys.ViewRoomAdminActivity;
...
public class HotelsAdapter extends RecyclerView.Adapter<HotelsAdapter.myViewHolder> {
    ...
    public HotelsAdapter(List<Hotel> productsList, Context context) {
    ...
    public void onBindViewHolder(myViewHolder holder, int position) {
        ...
        holder.cardView_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(context, ViewRoomAdminActivity.class);
