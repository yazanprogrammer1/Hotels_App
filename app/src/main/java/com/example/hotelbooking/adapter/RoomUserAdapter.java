...
import com.example.hotelbooking.Activitys.RoomDelailsUserActivity;
import com.example.hotelbooking.R;
import com.example.hotelbooking.model.Room;

import java.util.List;

public class RoomUserAdapter extends RecyclerView.Adapter<RoomUserAdapter.myViewHolder> {

    private List<Room> RoomList;
    private Context context;

    public RoomUserAdapter(List<Room> RoomList, Context context) {
    ...
    public void onBindViewHolder(myViewHolder holder, int position) {
        ...
        holder.cardView_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(context, RoomDelailsUserActivity.class);
